                      ...
                      <div class="row">
                          <div class="col-sm-6 col-sm-offset-3">
                              <form action="<c:url value='/TeacherServlet'/>" method="post">
                                  <input type="hidden" name="method" value="queryGrade"/>
                                  <div class="form-group">
                                      <label for="inputcourseID">课程编号</label>
                                      <input type="text" name="courseID" id="inputcourseID" />
                                  </div>
                                  <div class="form-group">
                                      <label for="inputcourseName">课程名称</label>
                                      <input type="text" name="courseName" id="inputcourseName">
                                  </div>
                                  <div class="form-group">
                                  ...
                                  <div class="form-group">
                                      <label for="inputstID">学生编号</label>
                                      <input type="text" name="studentID" id="inputstID">
                                  </div>
                                  <div class="form-group">
                                      <input type="submit" value="查询成绩" onclick="add()"class="btn btn-default btn-sm"/>
