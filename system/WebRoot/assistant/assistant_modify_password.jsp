							  ...
							  <div class="col-sm-12">
								  <form action="<c:url value = '/AssistantServlet'/>" method="post">
									  ...
									  <div class="form-group" id="inputPasswordFormgroup">
										  <label for="inputPassword" class="col-sm-3 col-sm-offset-2 control-label">请输入新密码</label>
										  <div class="col-sm-4">
											  <input type="password" name="asPassword" placeholder="请输入..." id="inputPassword">
											  <span id="helpBlock" class="help-block">长度8-16位，字母，数字，符号至少包含两种</span>
										  </div>
									  </div>
									  <div class="form-group" id="reinputPasswordFormgroup">
										  <label for="inputPassword" class="col-sm-3 col-sm-offset-2 control-label">再次输入密码</label>
										  <div class="col-sm-4">
											  <input type="password" name="reAsPassword" id="reinputPassword">
											  <span id="helpBlock" class="help-block">请保证两次输入密码相同</span>
										  </div>
									  </div>
									  <div class="row">
										  <button type="button" class="btn btn-default btn-sm col-sm-offset-7" onclick="checkPassword()">完成</button>
									  </div>
								  </form>
							  </div>
						  </div>
