      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header" align="center" style="border: 0px;">
            ...
            <h4 class="modal-title"  style=" color:#000;">查询班级</h4>
          </div>
          <div class="modal-body">
				<form action="<c:url value='/AdminServlet'/>" method="post" style="text-align:center">
						<input type="hidden" name="method" value="queryAcLinker"/>
						 	<div class="form-group">
                                 <label for="assistantID">导员工号</label>
                                 <input type="text" name="assistantID" id="assistantID">
                            </div>
							<div class="form-group">
