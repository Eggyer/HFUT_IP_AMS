		  ...
		  <div class="row">
			  <div class="col-sm-8 col-sm-offset-2">
				  <div class="panel panel-default"  style="position:fixed;top:20%; left:10%;height:80%; width:80%;background-color:#FFF">
					  <div class="panel-heading"><h4 class="centerh"><strong>课程列表</strong></div>
							  ...
							  <tbody >
										<c:forEach items="${requestScope.crList}" var="crList">
											<tr>
										        ...
										        <td>
										          <a href="<c:url value='/AdminServlet?method=preEditCourse&courseID=${crList.crID}'/>">编辑</a>
										          <a href="<c:url value='/AdminServlet?method=delCourse&courseID=${crList.crID}'/>">删除</a>
										        </td>
											</tr>
										</c:forEach>
							  </tbody>
