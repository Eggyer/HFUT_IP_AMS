      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header" align="center" style="border: 0px;">
            ...
            <h4 class="modal-title"  style=" color:#000;">编辑导员信息</h4>
          </div>
          <div class="modal-body">
				<form action="<c:url value='/AdminServlet'/>" method="post" style="text-align:center">
				<input type="hidden" name="method" value="editAssistant"/>
						 	<div class="form-group">
                                 <label for="asIDidid">导员工号</label>
								 ${as.asID}
								 <input type="hidden" name="asID" id="asIDid" value="${as.asID }"/>
                            </div>
							<div class="form-group">
                                 <label for="asNameid">导员姓名</label>
          						 <input type="text" name="asName" id="asNameid" value="${as.asName }">
             					 <label id="asNameError" class="error">&nbsp;</label>
                            </div>	
                            <div class="form-group">
                                 <label for="selector">导员学院</label>
						         <input type="text" name="asCollege" value="${as.asCollege }">
						         <label id="asCollegeError" class="error"></label>
                            </div>
                            <div class="form-group">
                                 <label for="selector">修改班级</label>
							     <c:forEach items="${requestScope.acLinkers}" var="acLinkers">
					             <input type="checkbox" name="asClass"  value ="${acLinkers.stClass}">${acLinkers.stClass}
					             </c:forEach>
