      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header" align="center" style="border: 0px;">
            ...
            <h4 class="modal-title"  style=" color:#000;">查询教师</h4>
          </div>
          <div class="modal-body">
				<form action="<c:url value='/AdminServlet'/>" method="post" style="text-align:center">
						<input type="hidden" name="method" value="queryTeacher"/>
						 	<div class="form-group">
                                 <label for="assistantID">教师工号</label>
                                 <input type="text" name="tcID" />
                            </div>
							<div class="form-group">
                            ...
                            <div class="form-group">
                                 <label for="tcCollegeid">教师学院</label>
          						 <input type="text" name="tcCollege">
                            </div>		
