		  ...
		  <div class="row">
			  <div class="col-sm-8 col-sm-offset-2">
				  <div class="panel panel-default"  style="position:fixed;top:20%; left:10%;height:80%; width:80%;background-color:#FFF">
					  <div class="panel-heading"><h4 class="centerh"><strong>成绩信息</strong></div>
					  <div class="table table-responsive" style="position:absolute;top:10%;height:85%; width:100%; background-color:#FFF; overflow:auto">
						  <table class="table table-striped table-hover table-bordered">
							  ...
							  <tbody >
									<c:forEach items="${requestScope.tcList}" var="tcList">
										<tr>
											<td>${tcList.tcID}</td>
									        <td>${tcList.tcName}</td>
									        <td>${tcList.tcCollege}</td>
									        <td>
									          <a href="<c:url value='/AdminServlet?method=preEditTeacher&tcID=${tcList.tcID}'/>">编辑</a>
									          <a href="<c:url value='/AdminServlet?method=delTeacher&tcID=${tcList.tcID}'/>">删除</a>
									        </td>
										</tr>
									</c:forEach>
							  </tbody>
